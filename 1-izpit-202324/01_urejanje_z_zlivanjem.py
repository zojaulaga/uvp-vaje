...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDE5NywidXNlciI6MTE0NTR9:1x3wDT:rao7uEfErS1ueec9ZgOVSMIrxkXV8YOBs3oe__OvArw"
        try:
            tests = [
                ([1, 2, 3], [4, 5, 6], [1, 2, 3]),
                ([1], [2], [1]),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDE5OCwidXNlciI6MTE0NTR9:1x3wDT:6Ws7ew-EnhrdMLh4tFVm9yTo7QC6GlKJLeeDoJS7NSo"
        try:
            tests = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0MDE5OSwidXNlciI6MTE0NTR9:1x3wDT:MIfS20CeT7Q3AoYQug_yWxUUpl3eiFx3nclY9jn9Yac"
        try:
            tests = (
