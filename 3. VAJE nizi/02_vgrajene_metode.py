...
def odstrani_samoglasnike(niz):
    ...
    i = 0
    while i < len(niz) and niz[i] in samoglasniki:
        i += 1
...
def prestej_posebno(niz, c, k):
    ...
    for crka in niz:
        # Če zagledamo črko c, si to zabeležimo
        if crka == c:
            videni_c += 1
            
        # Če smo videli že vsaj k črk c IN je trenutni znak presledek:
        if videni_c >= k and crka == " ":
            presledki += 1
            
    return presledki
##upoorabili smo crka in niz in ne i in range ker nas ne zanimajo lih metsa ampak znaki!!
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MSwidXNlciI6MTE0NTR9:1w28s9:PySd67Vtqh3M2PyyhuCJv2WDd0r_BsBQouWrOPrK39I"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MiwidXNlciI6MTE0NTR9:1w28s9:hUUIYswQ8NF55mvTJioPhJgoknFc7LCTBXv9wsJKf08"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4MywidXNlciI6MTE0NTR9:1w28s9:RghMKqd4grLbv00LYXdlQGO9SGAOzeqzt97-lHC_9BU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NCwidXNlciI6MTE0NTR9:1w28s9:hb5Q6aOhV-uOXoG5_JE8JeKDS1txRjTnQBMCR9mgdQA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NSwidXNlciI6MTE0NTR9:1w28s9:QCiwhkjr5mvHX9vNHiOL9cjOrswqwVjtnqsLtVztFhk"
        try:
