...
def zmnozi(stevilo1, stevilo2):
    rezultat = f"{stevilo1 * stevilo2:.7f}"
# =====================================================================@027495=
# 3. podnaloga
...
#     "-RACUN---0000010\nCena: 50 EUR\nDDV: 11\nSkupno: 61\nHvala za obisk"
# =============================================================================
#def turist(st_racuna, cena, stopnja_DDV):
#    
#    izpise = f"RACUN---{n}\nCena: {cena} EUR\nDDV: {stopnja_DDV}\nSkupno: b\nHvala za obisk"

def turist(stevilka, cena, ddv_odstotek):
    ddv = int(cena * ddv_odstotek / 100)
    skupno = cena + ddv
    return f"-RACUN---{stevilka:07d}\nCena: {cena} EUR\nDDV: {ddv}\nSkupno: {skupno}\nHvala za obisk"    
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MywidXNlciI6MTE0NTR9:1w28s9:pM56hczWNi48KOEQko2oUnUHgrcqwjZV3hRccddFQq0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NCwidXNlciI6MTE0NTR9:1w28s9:dhYN9Ii87oGM7YrB1ofp_kQEzVUY-240eWoulAHIb9g"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NSwidXNlciI6MTE0NTR9:1w28s9:IHS8LSWO6IRfuHtIiQaijKIRMtQfffKZIZ-MFe_4V9I"
        try:
