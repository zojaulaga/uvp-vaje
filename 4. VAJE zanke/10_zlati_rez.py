...
# podano natančnost.
# =============================================================================
def natancni_priblizek(natancnost):
    prejsnji = 1
    trenutni = naslednji_priblizek(prejsnji)

    # Dokler je razlika med njima še prevelika:
    while abs(trenutni - prejsnji) >= natancnost:
        prejsnji = trenutni
        trenutni = naslednji_priblizek(trenutni)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAwLCJ1c2VyIjoxMTQ1NH0:1w28t9:x62_OycxSWyB9so8k7q-KFER0hrb0daOxHjkFzmo7Mo"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAxLCJ1c2VyIjoxMTQ1NH0:1w28t9:FZn0-CYvWWffEep5QRAcwDpedX2s15D4aR0jXSNbHWI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAyLCJ1c2VyIjoxMTQ1NH0:1w28t9:dcOI33xTwPPD7JxCt6z5UOpquXLLIhN7G-Ls2s_-8EM"
        try:
