...
# =============================================================================
def pravilni_del_gesla(geslo, ugibi):
    s = ""
    for znak in geslo:
       if znak in ugibi:
           s += znak
...
#     'j?'
# =============================================================================
def nepravilni_ugibi(geslo, ugibi):
    s = ""
    for znak in ugibi:
...
##ce pise v ugibih funkcija naj vrne ugibane crke potem po ugibih tam for zanke in ugibi
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NSwidXNlciI6MTE0NTR9:1w28t9:oDSRAI84wsxyW8g1ycKCGBI_wcbMOmxcWTvV_IY8X0c"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NiwidXNlciI6MTE0NTR9:1w28t9:4dsxXchr50j7irayD3MT9pZOchq8RL-xs7sVLWC2qxg"
        try:
