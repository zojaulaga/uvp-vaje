...
def hitri(tek):
    x = 0
    y = 0
    dolzina = 1  # Privzeto je vsak korak dolg 1

    for znak in tek:
        if znak in "123456789":  # Če je znak števka od 1 do 9
            dolzina = int(znak)  # Zapomnimo si novo dolžino

        elif znak == "S":
            y += dolzina  # Premik za shranjeno dolžino
            dolzina = 1  # Ponastavimo nazaj na 1 za naprej
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODYyLCJ1c2VyIjoxMTQ1NH0:1w28t9:MY35PVuWxVv6-2ceE7lxJLHUau4VcPH9oU5dLQR3gvk"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODYzLCJ1c2VyIjoxMTQ1NH0:1w28t9:oMee4j6a6YLH3OXA5ILbrsdvzXxTZs5BrlzvleUSEsg"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODY0LCJ1c2VyIjoxMTQ1NH0:1w28t9:5EMRWDtLBTtDdgBhHizLL48m43L-gx3HivovlyO0Ldg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODY1LCJ1c2VyIjoxMTQ1NH0:1w28t9:6lBoBCIywjOovsFbjrN7RbEo6wuPrDoYi0def-40FM0"
        try:
