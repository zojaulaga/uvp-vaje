...
def poglej_in_povej():
    ...
    while True:
        ...
        while i < len(trenutni):
            stevec = 1
            while (
                i + 1 < len(trenutni) and trenutni[i] == trenutni[i + 1]
            ):
                stevec += 1
                i += 1
            naslednji += str(stevec) + trenutni[i]
            i += 1
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTI4LCJ1c2VyIjoxMTQ1NH0:1x41t3:gvNV601jCYOw0GXvW2aRAL8HA8YzVdK8oSEDHGfgmEU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTI5LCJ1c2VyIjoxMTQ1NH0:1x41t3:10knoRNGX41XUSIAQwcjbPwVwlkU9zZ8r7cNqM3rY7c"
        try:
