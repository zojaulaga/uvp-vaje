...
def uredi(teze, starosti):
    seznam_zajcev = []
    for t, s in zip(teze, starosti):
        seznam_zajcev.append(Zajec(t, s))

    seznam_zajcev.sort()  # Uredi jih od najmanjšega do največjega
    return seznam_zajcev
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA2LCJ1c2VyIjoxMTQ1NH0:1x41t3:jzZ3tn1kjZUeqjPe5VJW5cEV8_XoU_heqFK6gMAarMI"
        try:
            test_data = [
                ('Zajec(5, 3).teza', 5),
                ('Zajec(5, 3).starost', 3),
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA3LCJ1c2VyIjoxMTQ1NH0:1x41t3:bJ65BZ-JfaALo6pD8UPSFmiqAPVYoZTfNZxhBRBFAJI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA4LCJ1c2VyIjoxMTQ1NH0:1x41t3:VjbDo3NiS6doyGalk9G3xAmwPzrj4xrq07V0H3pYs-U"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzA5LCJ1c2VyIjoxMTQ1NH0:1x41t3:kwDlSAjAzbnD1zh1aUkNRrBNMc0IRhsFWuu77UHqDPE"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzEwLCJ1c2VyIjoxMTQ1NH0:1x41t3:ryDvuUUWzs94pPoSQz2grRvmyzTQGuMnmDF5BRDaaxE"
        try:
            prav = (
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzExLCJ1c2VyIjoxMTQ1NH0:1x41t3:3QXTjs51Y0YFUfB4tjGpe1DuBXoXZsV8Xnke2DaZkIA"
        try:
