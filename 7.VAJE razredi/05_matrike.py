...
class Matrika:
    ...
    def __init__(self, matrika):
        self.matrika = [list(vrstica) for vrstica in matrika]
    ...
    def __add__(self, other):
        ...
        for i in range(self.visina):
            nova_vrstica = [
                self.matrika[i][j] + other.matrika[i][j]
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2MiwidXNlciI6MTE0NTR9:1x41t3:uSXlKvFo44ZzM-ef30ajRDhp5TtlcwFuicYnKUT-144"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2MywidXNlciI6MTE0NTR9:1x41t3:Y4TFChWqDfq1k7z88eOimRn-seDmDCD0k0rpLbpzo-Y"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2NCwidXNlciI6MTE0NTR9:1x41t3:M96wcfnLo00fYcDyZVbp617IMOQIwQiOQpQAxmFZvVc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2NSwidXNlciI6MTE0NTR9:1x41t3:3SEERpVG-d6fUNgnnE5s1IQKaRHFiCFpM4oqXQr9k4A"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2NiwidXNlciI6MTE0NTR9:1x41t3:_hVm5cXF6cOUFgPXqHivD3rXbZyG3x1wiO_Fr6i87Ik"
        try:
