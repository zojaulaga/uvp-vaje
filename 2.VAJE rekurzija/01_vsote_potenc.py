...
# =============================================================================
def vsota_prvih(n):
    vsota = n + vsota_prvih(n - 1) if n > 0 else 0
    return vsota
# =====================================================================@000954=
# 2. podnaloga
...
def vsota_prvih_kvadratov(n):
    vsota = n**2 + vsota_prvih_kvadratov(n - 1) if n > 0 else 0
    return vsota
# =====================================================================@000955=
# 3. podnaloga
...
def vsota_prvih_potenc(n, k=1):
    vsota = n**k + vsota_prvih_potenc(n-1,k) if n > 0 else 0
    return vsota
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTMsInVzZXIiOjExNDU0fQ:1vx4zR:83rFJ431qwhoiAh9o47vtZqw36wLZk_MrHEEq3d5p_Q"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTQsInVzZXIiOjExNDU0fQ:1vx4zR:tGieu0JitP3TJ_sjp6DPyg727xUZRCoxGikbtM25-zg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTUsInVzZXIiOjExNDU0fQ:1vx4zR:K0ZSrB4vWKU8Ym-YZcXm085VbCzqqCS_H5Lpw09aNKc"
        try:
            try:
