...
# =============================================================================
def vsota_stevk(n):
    vsota = n % 10 + vsota_stevk(n // 10) if n > 0 else 0
    return vsota
# =====================================================================@000957=
# 2. podnaloga
...
def vsota_vecjih_stevk(n, k=0):
    vsota = (n % 10 if n % 10 >= k else 0) + vsota_vecjih_stevk(n // 10, k) if n > 0 else 0
    return vsota
# =====================================================================@000958=
# 3. podnaloga
...
def vsota_stevk_stevil_med(m, n):
    vsota = vsota_stevk(m) + vsota_stevk_stevil_med(m + 1, n) if m <= n else 0
    return vsota
# =====================================================================@000959=
# 4. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTYsInVzZXIiOjExNDU0fQ:1vx4zR:LK4H6QvNXCGqiw9IH01mh9rYRFXhKij6LiJu1qgfN4s"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTcsInVzZXIiOjExNDU0fQ:1vx4zR:BTdAjPPCCDNoBeSOD8ftSY-kAVzP4qXnXGE7xEbByuI"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTgsInVzZXIiOjExNDU0fQ:1vx4zR:-QwgXlAhkc4ogCq1YfawbKGsFou3IiPDl3KV8lgkRWo"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTksInVzZXIiOjExNDU0fQ:1vx4zR:K5v39BINSyldbp4M5zI-8BKMIzsvhSLjhREC43Kwiis"
        try:
            for i in range(1, 100):
