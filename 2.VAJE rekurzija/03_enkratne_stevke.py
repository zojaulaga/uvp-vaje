...
def kolikokrat_se_pojavi_stevka(k, n):
    ...
    return (1 if n % 10 == k else 0) + kolikokrat_se_pojavi_stevka(k, n // 10)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNSwidXNlciI6MTE0NTR9:1vx4zR:Akv1jzKJEbZyGltXjlc9DDysMbfS7KKIH_X5pm24tuE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNiwidXNlciI6MTE0NTR9:1vx4zR:AFhJuisrbNWnJQgXX08Zufr4SdAgo3HKdnPzmmW0sQc"
        try:
