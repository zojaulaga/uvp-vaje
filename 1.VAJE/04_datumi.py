...
def je_veljaven_datum(dan, mesec, leto):
    if mesec < 1 or mesec > 12:
        return False
    elif dan < 1 or dan > stevilo_dni(mesec, leto):
        return False
    else:
        return True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjcsInVzZXIiOjExNDU0fQ:1vuYaK:TYJvLOy2c0o0MOl8t5ebliR5vZ5vpnw8f8Fodkabvy0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjgsInVzZXIiOjExNDU0fQ:1vuYaK:qQ7VsQ9gXKSDMoZEvPBjN0lQlQ487bOLOmfVfZp8RHM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5MjksInVzZXIiOjExNDU0fQ:1vuYaK:lUi_CaZ0MAl_2WgRZQx7LplV3XmZ87oN4QbEmmclzMI"
        try:
