...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDgxNiwidXNlciI6MTE0NTR9:1x4BRK:AzpcIUebc1sVZi6ydl6yEnpStkdKIGTem5IVtwwaUfM"
        try:
            tests = [
                ('potokrog', ['pot', 'o', 'potok', 'krog', 'rog'], ['pot', 'potok']),
                ('potokrog', ['pot', 'potok'], ['pot', 'potok']),
                ('potokrog', ['po', 'pot', 'rabarbara'], ['po', 'pot']),
                ('potokrog', ['po', 'rabarbara'], ['po']),
                ('catsanddogs', ['cat', 'cats', 'and', 'sand', 'dogs'], ['cat', 'cats']),
                ('catsanddogs', ['cat', 'and', 'sand', 'dogs'], ['cat']),
                ('aaa', ['a', 'aa', 'aaa'], ['a', 'aa', 'aaa']),
            ]
            
            for n, s, r in tests:
                Check.equal(f"se_zacne({repr(n)}, {repr(s)})", r)
        except TimeoutError:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDgxNywidXNlciI6MTE0NTR9:1x4BRK:JtnfP5FKHESjSXyYLQ0F3jLLtsvc0jst8lBs7wZMxc0"
        try:
            tests = [
                ('potokrog', ['pot', 'o', 'potok', 'krog', 'rog'], True),
                ('potokrog', ['p', 'potok', 'krog'], False),
                ('catsanddogs', ['cat', 'cats', 'and', 'sand', 'dogs'], True),
                ('catsanddogs', ['cat', 'and', 'sand', 'dogs'], True),
                ('abba', ['a', 'bb'], True),
                ('aaa', ['a', 'aa', 'aaa'], True),
                ('rabarbara', ['ba', 'na'], False)
            ]
            
            for n, s, r in tests:
                Check.equal(f"se_razbije({repr(n)}, {repr(s)})", r)
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
            Check.error(
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo0NDgxOCwidXNlciI6MTE0NTR9:1x4BRK:QFJcPrjCfYsb3LuslMOfqtzZUZfGviAEXPywiPO2hAQ"
        try:
            tests = [
                ('potokrog', ['pot', 'o', 'potok', 'krog', 'rog'], {('pot', 'o', 'krog'), ('potok', 'rog')}),
                ('potokrog', ['p', 'potok', 'krog'], set()),
                ('catsanddogs', ['cat', 'cats', 'and', 'sand', 'dogs'], {('cats', 'and', 'dogs'), ('cat', 'sand', 'dogs')}),
                ('catsanddogs', ['cat', 'and', 'sand', 'dogs'], {('cat', 'sand', 'dogs')}),
                ('abba', ['a', 'bb'], {('a', 'bb', 'a')}),
                ('aaa', ['a', 'aa', 'aaa'], {('a', 'a', 'a'), ('a', 'aa'), ('aa', 'a'), ('aaa',)})
            ]
            
            for n, s, r in tests:
                Check.equal(f"razbitja({repr(n)}, {repr(s)})", r)
        except TimeoutError:
            Check.error("Dovoljen čas izvajanja presežen")
        except Exception:
            Check.error(
