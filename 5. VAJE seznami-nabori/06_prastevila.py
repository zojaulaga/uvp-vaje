...
def je_prastevilo(n):
    ...
    for d in range(2, n):
        if n % d == 0:
            return False  # Našli smo delitelja, torej ni praštevilo
            
    return True  # Nobeno število ga ni delilo, torej je praštevilo
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODA5LCJ1c2VyIjoxMTQ1NH0:1w4gPR:RKf5pXYBJ9YA9A7wNaWP8xDyg0sAbzep6sjDYTUms4g"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODEwLCJ1c2VyIjoxMTQ1NH0:1w4gPR:FT4c4tUgLu-CS9ylyp0cjZ1NTOAwOSA6fuOTmhhkDKg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODExLCJ1c2VyIjoxMTQ1NH0:1w4gPR:TdzWwuKEBExW3Lvg3fhvMRfr10s8BdOM-PlOEP05lJg"
        try:
