...
# =============================================================================
def pripravi_primer(elementi, indeksi):
    primer = []
    for i in range(len(elementi)):
        par = (elementi[i], indeksi[i])
        primer.append(par)
    return primer
# =====================================================================@027625=
# 2. podnaloga
...
def pravilno_urejen(primer):
    for i in range(len(primer)):
        # primer[i][1] je druga številka v paru na mestu i
        if primer[i][1] != i:
            return False
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyNCwidXNlciI6MTE0NTR9:1w4gPR:_Me71c0mJhHzHgultEJsLZSnGtPKqhwxLD3E2ZXpHEc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyNSwidXNlciI6MTE0NTR9:1w4gPR:AY4wGV6-u9LYIaIQGU6W-hL-_7sCUFoGtyZrTG0AFtI"
        try:
