...
#     False
# =============================================================================
def vecji_element(seznam, število):
...
#    if not seznam: ##if seznam == []:, pogoj je na prazno izpoljen
#        return True
#    prvi = seznam[0]             ##else: for i in range(1, len(seznam)):   to pomeni da pregledamo vse ostale razen prvega                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          
#    for element in seznam[1:]:   ##if sez[i] > sez[0]:
#        if element > prvi:       ##return False in pol še return True
#            return False
#    return True
...
def vsi_vecji(sez1, sez2):   
    for a in sez1:    ##pri vsakem aju pregledamo vse elemente bja
        for b in sez2:
            if a < b:
                return False
    return True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEyOCwidXNlciI6MTE0NTR9:1w4gPR:Lf6BWnrFGTt2ApL_Ek73gZHTtBvnmeWT_yIkQeLyVdc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEyOSwidXNlciI6MTE0NTR9:1w4gPR:zRtSH4wlrm_AwfBHYHSlRg4NoVQkPnbK6PIrtqy0Cys"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzEzMiwidXNlciI6MTE0NTR9:1w4gPR:QDfRZwU3awrusLWTk5HgiaChv_uJ6WMurG1FyAdINqY"
        try:
