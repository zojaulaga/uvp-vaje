...
#     ['mami', 'ati']
# =============================================================================
def druzinski_clani(slovar):
    return list(slovar.keys()) #slovar.keys() pomeni da uzame samo kljuce in jih pretvori v seznam z ukazom list()

#def druzinski_clani(slovar):
#    seznam_clanov = []          # 1. Pripravimo prazen seznam
#    for clan in slovar:         # 2. Zanka gre čez vse ključe v slovarju
#        seznam_clanov.append(clan)  # 3. Vsakega člana dodamo v seznam
#    return seznam_clanov        # 4. Vrnemo napolnjen seznam
# =====================================================================@020338=
# 2. podnaloga
...
def zdruzi_sladkosnede(domaci, njihovi):
    rezultat = domaci.copy()

    for ime, sladica in njihovi.items():
        if ime not in rezultat:
            rezultat[ime] = sladica #temu imenu pripisi sladico
    return rezultat
# =====================================================================@020339=
# 3. podnaloga
...
#     {'pita': 1}
# =============================================================================
def nakupovalni_seznam(sladkosnedi, gostje):
    rezultat = {}
    for gost in gostje:
        if gost in sladkosnedi:
            ...
            if sladica in rezultat:
                rezultat[sladica] += 1 ##vedno navedi slovar in ključ
            else: 
                rezultat[sladica] = 1
    return rezultat
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzNywidXNlciI6MTE0NTR9:1x3zmU:C2cnD8vooOIZkvCmWMbinLidVV_jJpSsJL2yypkgrFQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzOCwidXNlciI6MTE0NTR9:1x3zmU:YahHkvn0P1KYaCfgIE9pBB3I1rKw7QDglrTauVc4U6k"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDMzOSwidXNlciI6MTE0NTR9:1x3zmU:qiO9ot-SDkEkm4c-xc4YupSzODJMVN5S1tW04be9TAU"
        try:
