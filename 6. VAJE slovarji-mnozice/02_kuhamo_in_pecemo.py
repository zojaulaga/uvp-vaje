...
def ali_imamo_sestavine(recept, shramba):
    for sestavina in recept:
        if recept[sestavina]> shramba.get(sestavina, 0):
            return False
    return True
...
def kaj_moramo_se_kupiti(recept,shramba):
    rezultat = {}
    for sestavine in recept:
        if shramba.get(sestavine, 0)<recept[sestavine]:
            rezultat[sestavine] = recept[sestavine]-shramba.get(sestavine, 0)
    return rezultat
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkyLCJ1c2VyIjoxMTQ1NH0:1x3zmU:b1xvVhBNmtZUVMENYWW0EDd3n4DLgxpFdWE7e720bfc"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzkzLCJ1c2VyIjoxMTQ1NH0:1x3zmU:b_meh5_O39dpzRS-ExbMNrllqkoiQzBMtHb-g3T8Geg"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzk0LCJ1c2VyIjoxMTQ1NH0:1x3zmU:OHmZi9OQktNteKMLfJq-4bwjUgvZ7j7mhHrRivzxsag"
        try:
